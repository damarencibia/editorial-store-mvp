  ...
  <div class="relative" ref="containerRef">
    ...
    <div class="hidden sm:block relative">
      ...
      <div
        ...
        class="absolute top-full left-0 right-0 mt-1 rounded-lg border border-border bg-surface-2 shadow-lg overflow-hidden z-50"
      >
        ...
        <template v-else-if="hasResults">
          <!-- Books -->
          <div v-if="results.books.length > 0">
            <p class="px-3 pt-3 pb-1 text-[11px] font-semibold uppercase tracking-wider text-text-muted">Libros</p>
            <a
              v-for="book in results.books"
              :key="'b' + book.id"
              :href="`/book/${book.slug}`"
              @click="close"
              class="flex items-center gap-3 px-3 py-2 hover:bg-surface-3 transition-colors"
            >
              <div class="w-10 h-13 rounded flex-shrink-0 bg-surface-3 overflow-hidden">
          ...
          <!-- Authors -->
          <div v-if="results.authors.length > 0">
            <p class="px-3 pt-3 pb-1 text-[11px] font-semibold uppercase tracking-wider text-text-muted">Autores</p>
            <a
              ...
              class="flex items-center gap-3 px-3 py-2 hover:bg-surface-3 transition-colors"
            >
              <div class="w-8 h-8 rounded-full flex-shrink-0 bg-surface-3 overflow-hidden">
          ...
          <!-- Collections -->
          <div v-if="results.collections.length > 0">
            <p class="px-3 pt-3 pb-1 text-[11px] font-semibold uppercase tracking-wider text-text-muted">Colecciones</p>
            <a
        ...
        <div v-else class="px-3 py-8 text-center text-sm text-text-dim">
